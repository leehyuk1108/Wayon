...
def main(demo=False):
  ...
  sm = SubMaster(["deviceState", "carState", "carStateSP", "roadCameraState", "liveCalibration", "driverMonitoringState", "carControl", "liveDelay"])
  ...
  DH = DesireHelper()
  lane_change_input_monitor = LaneChangeInputMonitor()
