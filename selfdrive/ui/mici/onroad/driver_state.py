...
from openpilot.selfdrive.monitoring.helpers import DistractedType, face_orientation_from_net
...
class DriverStateRenderer(Widget):
  ...
  def _render(self, _):
    ...
    if phone_amount > 0.01:
      ...
      dest_rect = rl.Rectangle(
        ...
        self._phone_icon.width * pulse,
        self._phone_icon.height * pulse,
      )
      rl.draw_texture_pro(
        self._phone_icon,
        source_rect,
  ...
  def get_driver_data(self):
    ...
    self._phone_detected = bool(dm_state.distractedType & DistractedType.DISTRACTED_PHONE)
