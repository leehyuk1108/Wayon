...
class PowerMonitoring:
  ...
  def should_shutdown(self, ignition: bool, in_car: bool, offroad_timestamp: float | None, started_seen: bool, starpilot_toggles: SimpleNamespace | None = None):
    # Wayon keeps comma powered on; ignore offroad timer, low-voltage,
    # capacity, DisablePowerDown, and ForcePowerDown shutdown paths.
    return False
